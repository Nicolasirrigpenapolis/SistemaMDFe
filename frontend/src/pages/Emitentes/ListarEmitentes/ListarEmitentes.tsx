...
export function ListarEmitentes() {
  ...
  const handleCNPJDataFetch = (data: any) => {
    // Esta função será chamada quando o CNPJ for consultado automaticamente
    // Os dados serão automaticamente preenchidos pelo GenericFormModal
                ...
                <div key={emitente.id} className="grid grid-cols-6 gap-4 p-4 border-b border-gray-200 dark:border-0 hover:bg-background dark:hover:bg-gray-700 transition-colors duration-200">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      {emitente.bairro ? `${emitente.bairro}, ` : ''}{emitente.municipio || 'Não informado'}/{emitente.uf}
                    </div>
                  </div>
                  <div className="text-center flex justify-center">
                    <span className={`text-sm font-semibold ${
