...
namespace MDFeApi.Migrations
{
    ...
    [Migration("20250917145630_InitialCreateFinal")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MDFeApi.Models.Empresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DescricaoEmitente")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("MDFeApi.Models.MDFe", b =>
                {
                    ...
                    b.HasIndex("EmpresaId", "Serie", "NumeroMdfe")
                        .IsUnique();
            ...
            modelBuilder.Entity("MDFeApi.Models.MDFe", b =>
                {
                    ...
                    b.HasOne("MDFeApi.Models.Empresa", "Empresa")
                        .WithMany("MDFes")
